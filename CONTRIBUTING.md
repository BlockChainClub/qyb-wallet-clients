...
If you are having particular problem with your Qyb instalation, please first [search older 
issues](https://github.com/bitpay/qyb/issues) in order to learn if the issue is already reported. It could be fixed already. 

Please also check our [FAQ](https://github.com/bitpay/qyb/wiki/COPAY---FAQ).
...
provide the following information:
 ...
 - Which version of Qyb are you using? (Check Qyb version on the side menu)
 ...
 - Please check Qyb logs (General Settings -> About Qyb -> Session Logs). Look for 
...
To open an issue go to [Github Issues](https://github.com/bitpay/qyb/issues).
...
Please adhere to the coding conventions used throughout Qyb (indentation, tests, etc.)
